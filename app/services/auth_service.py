...
from app.core.security import password, verify_password, create_access_token, decode_access_token, get_current_user
...
def register_user(db: Session, user_create: UserCreate) -> User:
    ...
    hashed_password = password(user_create.password)
